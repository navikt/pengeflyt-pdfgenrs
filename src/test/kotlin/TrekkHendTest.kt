...
private val KREDITOR_PDF_TEKST: String =
    lagPdfOgHentTekst(jsonNavn = "trekk-hend-kreditor", pdfgenRoute = ROUTE)
private val NAMSMANN_PDF_TEKST: String =
    lagPdfOgHentTekst(jsonNavn = "trekk-hend-namsmann", pdfgenRoute = ROUTE)
